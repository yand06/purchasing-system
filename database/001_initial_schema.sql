...
purchase_request_status VARCHAR(50) NOT NULL DEFAULT 'DRAFT',
...
purchase_order_status VARCHAR(50) NOT NULL DEFAULT 'DRAFT',
...
outbox_event_status VARCHAR(50) DEFAULT 'PENDING',
